{{-- resources/views/withholding-tax/show.blade.php --}}
<x-app-layout>
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 space-y-4 md:space-y-0">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 font-kanit">รายละเอียดหนังสือรับรองหัก ณ ที่จ่าย</h1>
            <p class="text-sm text-gray-500 font-kanit">แสดงข้อมูลการหักภาษี ณ ที่จ่ายสำหรับคู่ค้า</p>
        </div>
            ...
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="text-sm font-medium text-gray-900 bg-gray-50 p-3 rounded-xl border border-gray-100">
                            {{ \Carbon\Carbon::parse($withholdingTax->withholding_date)->format('d/m/Y') }}
                        </div>
                    </div>
        ...
        <div class="space-y-6">
            <div class="bg-blue-600 p-6 rounded-3xl shadow-xl text-white relative overflow-hidden font-kanit">
                ...
                <div class="space-y-5 relative z-10">
                    <div>
                        <label class="block text-xs opacity-80 mb-1">ยอดเงินก่อนหัก (Tax Base)</label>
                        <div class="text-2xl font-bold text-right">
                            {{ number_format($withholdingTax->tax_base, 2) }}
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="text-xl font-bold text-right">
                            {{ number_format($withholdingTax->tax_rate, 2) }}%
                        </div>
                    </div>
                    ...
                    <div class="border-t border-blue-400/50 pt-4 mt-2">
                        <div class="flex justify-between text-sm opacity-80 mb-1">
                            ...
                            <span class="text-xl font-bold">{{ number_format($withholdingTax->tax_amount, 2) }}</span>
                        </div>
                        ...
                        <div class="flex justify-between items-end pt-2">
                            <div>
                                ...
                                <span class="text-3xl font-bold tracking-tight">
                                    {{ number_format($withholdingTax->tax_base - $withholdingTax->tax_amount, 2) }}
                                </span>
                            </div>
            ...
            {{-- ข้อมูลเพิ่มเติม (เช่น ผู้บันทึก, วันที่แก้ไข) --}}
